                        ...
                        <ul class="divide-y divide-gray-200 w-full">
                            @forelse ($vacante->candidatos as $candidato)
                                <li class="p-3 flex items-center">
                                    ...
                                    <div>
                                        <a 
                                            class="inline-flex items-center shadow-sm py-0.5 px-1 border border-gray-300 text-sm leading-5 font-medium rounded-full text-gray-700 bg-white hover:bg-gray-50" 
                            ...
                            @empty
                                <p class="p-3 text-center text-sm">No hay candidatos aún</p>
                            @endforelse
                        </ul>
                    </div>
