<div>
    ...
    <div class="py-12 px-2 md:px-auto">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white shadow-sm rounded-lg p-6 divide-y divide-gray-200">
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        <div class="md:flex-1">
                            ...
                            <p class="font-bold text-xs text-gray-600">Último para postularse: <span class="font-normal">{{ $vacante->ultimo_dia->format('d/m/Y') }}</span></p>
                        </div>
                ...
                @empty
                    <p class="p-3 text-center text-sm text-gray-600">No hay Vacantes para buscar</p>
                @endforelse
            </div>
        </div>
